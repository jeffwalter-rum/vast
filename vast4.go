...
// ViewableImpression is the ad server may provide URIs for tracking publisher-determined view-ability
...
// Advertiser is an advertiser name, which can help publishers prevent display of the ad with its competitors.
...
// Verification contains the executable and bootstrapping data required to run the measurement code for a single verification vendor.
...
// At most one of these resources should be selected for execution, as best matches the technology available in the current environment.
