		...
		Ads: []Ad{
			{
				...
				InLine: &InLine{
					...
					AdTitle:  PlainString{"adTitle"},
					Impressions: []Impression{
						{ID: "11111", URI: CDATAString{"http://impressionv1.track.com"}},
						{ID: "11112", URI: CDATAString{"http://impressionv2.track.com"}},
					},
					Category: &[]Category{
						{Authority: "https://www.iabtechlab.com/categoryauthority", Category: PlainString{"American Cuisine"}},
						{Authority: "https://www.iabtechlab.com/categoryauthority", Category: PlainString{"Guitar"}},
					},
					...
					Creatives: []Creative{
						{
							...
							Linear: &Linear{
								...
								TrackingEvents: &[]Tracking{
									{Event: EventTypeStart, URI: CDATAString{"http://track.xxx.com/q/start?xx"}},
									{Event: EventTypeFirstQuartile, URI: CDATAString{"http://track.xxx.com/q/firstQuartile?xx"}},
									{Event: EventTypeMidpoint, URI: CDATAString{"http://track.xxx.com/q/midpoint?xx"}},
									{Event: EventTypeThirdQuartile, URI: CDATAString{"http://track.xxx.com/q/thirdQuartile?xx"}},
									{Event: EventTypeComplete, URI: CDATAString{"http://track.xxx.com/q/complete?xx"}},
								},
								MediaFiles: []MediaFile{
									{
										...
										Width:    1024,
										Height:   576,
										URI:      CDATAString{"http://mp4.res.xxx.com/new_video/2020/01/14/1485/335928CBA9D02E95E63ED9F4D45DF6DF_20200114_1_1_1051.mp4"},
									},
								},
							},
						},
	...
	"Ad":[
		{
			...
			"InLine":{
				...
				"Extensions":[{"Type":"ClassName","Data":"AdsVideoView"},{"Type":"ExtURL","Data":"http://xxxxxxxx"}],
				"Impressions":[{"ID":"11111","URI":"http://impressionv1.track.com"},{"ID":"11112","URI":"http://impressionv2.track.com"}],
				"Creatives":[
					{
						"ID":"987",
						"Linear":{
							"SkipOffset":"00:00:05",
							"TrackingEvents":[
								{"Event":"start","URI":"http://track.xxx.com/q/start?xx"},
								{"Event":"firstQuartile","URI":"http://track.xxx.com/q/firstQuartile?xx"},
								{"Event":"midpoint","URI":"http://track.xxx.com/q/midpoint?xx"},
								{"Event":"thirdQuartile","URI":"http://track.xxx.com/q/thirdQuartile?xx"},
								{"Event":"complete","URI":"http://track.xxx.com/q/complete?xx"}
							],
							"MediaFiles":[
								{"Delivery":"progressive","Type":"video/mp4","Width":1024,"Height":576,"URI":"http://mp4.res.xxx.com/new_video/2020/01/14/1485/335928CBA9D02E95E63ED9F4D45DF6DF_20200114_1_1_1051.mp4"}
							]
						}
					}
				]
...
func createVastDemo() (*VAST, error) {
	...
	assetId := "123456"
	impressionId := "456"
	impressionURI := CDATAString{"http://impression.track.cn"}
	seconds := Duration(15 * time.Second)
	mediaType := "video/mp4"
	mediaURI := CDATAString{"http://mp4.res.xxx.com/new_video/2020/01/14/1485/335928CBA9D02E95E63ED9F4D45DF6DF_20200114_1_1_1051.mp4"}
								...
								TrackingEvents: &[]Tracking{
									{
										...
										Offset: nil,
										URI:    CDATAString{"http://track.xxx.com/q/start?xx"},
										UA:     "",
									},
								},
								MediaFiles: []MediaFile{
		...
		"Ad":[
			{
				...
				"InLine":{
					...
					"Impressions":[{"ID":"456","URI":"http://impression.track.cn"}],
					"Creatives":[
						{
							"ID":"123456",
							"Linear":{
								"Duration":"00:00:15",
								"TrackingEvents":[{"Event":"start","URI":"http://track.xxx.com/q/start?xx"}],
								"MediaFiles":{
									"MediaFile":[{"Delivery":"progressive","Type":"video/mp4","Width":1024,"Height":576,"URI":"http://mp4.res.xxx.com/new_video/2020/01/14/1485/335928CBA9D02E95E63ED9F4D45DF6DF_20200114_1_1_1051.mp4"}]
								}
							}
						}
					]
...
func TestCreateVastXML(t *testing.T) {
	tests := []struct {
		...
		{
			name: "testCase1", want: []byte(`<VAST version="3.0" xmlns="http://www.iab.com/VAST"><Ad id="123"><InLine><AdSystem><![CDATA[DSP]]></AdSystem><Impression id="456"><![CDATA[http://impression.track.cn]]></Impression><AdTitle><![CDATA[ad title]]></AdTitle><Creatives><Creative id="123456"><Linear><Duration>00:00:15</Duration><TrackingEvents><Tracking event="start"><![CDATA[http://track.xxx.com/q/start?xx]]></Tracking></TrackingEvents><Duration>00:00:15</Duration><MediaFiles><MediaFile delivery="progressive" type="video/mp4" width="1024" height="576"><![CDATA[http://mp4.res.xxx.com/new_video/2020/01/14/1485/335928CBA9D02E95E63ED9F4D45DF6DF_20200114_1_1_1051.mp4]]></MediaFile></MediaFiles></Linear></Creative></Creatives></InLine></Ad></VAST>`),
			wantErr: false,
		},
	}
	for _, tt := range tests {
...
func TestInlineNonLinear(t *testing.T) {
	...
	if assert.Len(t, v.Ads, 1) {
		...
		if assert.NotNil(t, ad.InLine) {
			...
			assert.Equal(t, "http://mySurveyURL/survey", inline.Survey.URI.CDATA)
			...
			if assert.Len(t, inline.Creatives, 2) {
				...
				if assert.NotNil(t, crea1.NonLinearAds) {
					...
					if assert.Len(t, nonlin.NonLinears, 2) {
						...
						assert.Equal(t, "http://demo.tremormedia.com/proddev/vast/50x300_static.jpg", strings.TrimSpace((*nonlin.NonLinears)[0].StaticResource.URI.CDATA))
						assert.Equal(t, "image/jpeg", (*nonlin.NonLinears)[1].StaticResource.CreativeType)
						assert.Equal(t, "http://demo.tremormedia.com/proddev/vast/50x450_static.jpg", strings.TrimSpace((*nonlin.NonLinears)[1].StaticResource.URI.CDATA))
